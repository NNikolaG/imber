...
function Flatpickr(e, t) {
    ...
    function c(e, t, n) {
        return t instanceof Array ? t.forEach(function (t) {
            ...
            return c(e, t, n)
        }) : (e.addEventListener(t, n), void he._handlers.push({element: e, event: t, handler: n}))
    }
    ...
    function D(e) {
        var t = de("div", "numInputWrapper"), n = de("input", "numInput " + e), a = de("span", "arrowUp"),
            i = de("span", "arrowDown");
    ...
    function M(e) {
        ...
        var a = he.utils.getDaysinMonth(), i = window.document.createDocumentFragment(), r = he.prevMonthDays + 1 - t,
            o = 0;
        for (he.config.weekNumbers && he.weekNumbers.firstChild && (he.weekNumbers.textContent = ""), n && (he.minRangeDate = new Date(he.currentYear, he.currentMonth - 1, r), he.maxRangeDate = new Date(he.currentYear, he.currentMonth + 1, (42 - t) % a)); r <= he.prevMonthDays; r++, o++) i.appendChild(C("prevMonthDay", new Date(he.currentYear, he.currentMonth - 1, r), r, o));
    ...
    function L(e) {
        var t = e.target === he._input, n = F(e.target), r = he.config.allowInput, o = he.isOpen && (!r || !t),
    ...
    function R(e) {
        return function (t) {
            var n = he.config["_" + e + "Date"] = he.parseDate(t),
                a = he.config["_" + ("min" === e ? "max" : "min") + "Date"], i = t && n instanceof Date;
    ...
    function J() {
        if (void 0 !== he.calendarContainer) {
            var e = he.calendarContainer.offsetHeight, t = he.calendarContainer.offsetWidth, n = he.config.position,
                a = he._positionElement.getBoundingClientRect(), i = window.innerHeight - a.bottom,
            ...
            if (fe(he.calendarContainer, "arrowTop", !r), fe(he.calendarContainer, "arrowBottom", r), !he.config.inline) {
                var l = window.pageXOffset + a.left, c = window.document.body.offsetWidth - a.right,
    ...
    function V() {
        function e(e) {
            for (var t = e.length; t--;) "string" == typeof e[t] || +e[t] ? e[t] = he.parseDate(e[t], null, !0) : e[t] && e[t].from && e[t].to && (e[t].from = he.parseDate(e[t].from), e[t].to = he.parseDate(e[t].to));
    ...
    function ne(e) {
        return he._supportsEvents ? new Event(e, {bubbles: !0}) : (he._[e + "Event"] = document.createEvent("Event"), he._[e + "Event"].initEvent(e, !0, !0), he._[e + "Event"])
    }
